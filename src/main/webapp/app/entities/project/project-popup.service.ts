    ...
    open(component: Component, id?: number | any): NgbModalRef {
        ...
        if (id) {
            this.projectService.find(id).subscribe((project) => {
                ...
                project.createdTime = this.datePipe
                    .transform(project.createdTime, 'yyyy-MM-ddThh:mm');
                project.updatedTime = this.datePipe
                    .transform(project.updatedTime, 'yyyy-MM-ddThh:mm');
